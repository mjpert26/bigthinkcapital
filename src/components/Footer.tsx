  ...
  return (
    <footer className="bg-[#0e2366] text-white relative overflow-hidden" id="contact">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-[#1d3bbb]/15 opacity-60"></div>
        <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-[#f59e0b]/8 opacity-60"></div>
      </div>
