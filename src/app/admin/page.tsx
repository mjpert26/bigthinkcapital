...
export default function AdminPostsPage() {
  ...
  const handleDuplicate = async (post: BlogPost) => {
    ...
    // Generate a unique slug — append -copy, then -copy-2, -copy-3, etc. if needed
    ...
    const duplicate: Omit<BlogPost, 'id' | 'created_at' | 'updated_at'> = {
    ...
    const result = await createPost(duplicate);
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className="p-2 text-slate-400 hover:text-brand-400 hover:bg-brand-500/10 rounded-lg transition-all disabled:opacity-50"
                          title="Duplicate"
                        >
